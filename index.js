...
function displaydata(){
   ...
   var output=`Difference:The millisecond difference are ${millisecdiff}, seconds difference are ${seconddiff}, Minutes difference are ${minutediff}, Hours difference are ${hoursdiff}, Days differenece are ${daydiff}, Months difference are ${monthdiff}, Years difference are ${yeardiff}`;
   console.log(output);
   var differeneces=document.createElement('div');
   differeneces.innerHTML=output; 
   document.body.append(differeneces)
}
